        ...
        {joined && (
          <>
            ...
            <button
              ...
              } text-white ${computedCamDisabled ? "opacity-50 cursor-not-allowed" : "hover:opacity-90"}`}
            ...
            <button
              id="mic-btn"
              onClick={safe(onToggleMic, computedMicDisabled)}
              ...
              } text-white ${computedMicDisabled ? "opacity-50 cursor-not-allowed" : "hover:opacity-90"}`}
            ...
            <button
              ...
              } text-white ${computedScreenDisabled ? "opacity-50 cursor-not-allowed" : "hover:opacity-90"}`}
